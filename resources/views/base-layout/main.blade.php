...
<body>
    <header>
        ...
        <div class="row col-container w-100">
            <div class="col-6 col-md-4 text-logo mx-0">
                <div class="header-text">RECORDRACK</div>
            </div>
            <div class="col-6 col-md-8 mx-0 d-flex justify-content-end align-items-center pe-3 pe-md-5 nav-bar-container">
                <div class="d-none d-md-block header-nav">
                    <ul class="d-flex gap-5 justify-content-center align-items-center">
                        @yield('adminNavBarList')
                        @yield('navBarList')
